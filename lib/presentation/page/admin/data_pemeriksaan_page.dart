...
import 'package:posyandu_apps/presentation/page/admin/lakukan_penimbangan_page.dart';
...
class DataPenimbanganPage extends StatefulWidget {
  const DataPenimbanganPage({super.key});

  @override
  State<DataPenimbanganPage> createState() => _DataPenimbanganPageState();
}

class _DataPenimbanganPageState extends State<DataPenimbanganPage> {
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  Get.to(
                    () =>
                        LakukanPenimbanganPage(kegiatan: item, role: 'Pasien'),
                  );
                },
                child: Container(
                ...
                child: Material(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.to(() => LakukanPenimbanganPage(
                              kegiatan: item, role: 'Pasien'));
                        },
                        child: Container(
