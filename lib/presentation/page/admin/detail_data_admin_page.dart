...
class DetailDataAdminPage extends StatefulWidget {
  const DetailDataAdminPage(
      {Key? key,
      required this.nik,
      required this.nama,
  ...
  @override
  State<DetailDataAdminPage> createState() => _DetailDataAdminPageState();
}

class _DetailDataAdminPageState extends State<DetailDataAdminPage> {
