...
class ListPasienPage extends StatefulWidget {
  const ListPasienPage({super.key, required this.kegiatan});
  final Map kegiatan;
...
class _ListPasienPageState extends State<ListPasienPage> {
  ...
  menuOption(String value, Anak anak) async {
    if(value == 'hadir') {
      bool success = await SourceUser.addPresensi(anak.idAnak!, widget.kegiatan['id_kegiatan']);
      if(success) {
