...
class TBChart extends StatelessWidget {
  ...
  factory TBChart.withSampleData(double berat) {
    return new TBChart(
      _createSampleData(berat),
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData(double berat) {
    final desktopSalesData = [
      new LinearSales(0, 45.4),
      // new LinearSales(1, 2.5),
      // new LinearSales(1, 3.3),
      new LinearSales(2, 54.7),
    ];
